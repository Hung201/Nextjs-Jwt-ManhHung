...
const OwnerMenuItemOptionUpdate = ({ isUpdateModalOpen, setIsUpdateModalOpen, dataUpdate, setDataUpdate, menuItems }: IProps) => {
...
export default OwnerMenuItemOptionUpdate;
