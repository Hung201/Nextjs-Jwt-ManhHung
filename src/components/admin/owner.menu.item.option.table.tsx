...
import OwnerMenuItemOptionCreate from "./owner.menu.item.option.create";
import OwnerMenuItemOptionUpdate from "./owner.menu.item.option.update";
...
const OwnerMenuItemOptionTable = ({ menuItemOptions, meta, menuItems }: IProps) => {
    ...
    return (
        <>
            ...
            />
            <OwnerMenuItemOptionCreate
                isCreateModalOpen={isCreateModalOpen}
                setIsCreateModalOpen={setIsCreateModalOpen}
                menuItems={menuItems}
            />
            <OwnerMenuItemOptionUpdate
...
export default OwnerMenuItemOptionTable;
